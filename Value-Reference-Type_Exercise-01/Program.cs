...
namespace Value_and_Reference_Types_Exercise_01
{
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            Console.Write($"Before: {myDouble}");
            Console.Write($"Before: {myInteger}");
            Console.Write($"Before: {myString}");
            ...
            Console.WriteLine($"Original: {myDouble}");
            Console.WriteLine($"Original: {myInteger}");
            ...
            Methods.AddSpaces(1);
            Console.WriteLine($"Before: {myDogObject}");
            Methods.AddSpaces(1);
            ...
            Console.WriteLine($"After: {myDogObject}");
        }
